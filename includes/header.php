...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="http://www.optimizaclick.com" style="padding-top:5px;"><img src="<?php echo $home;?>/wp-content/plugins/lifeguard-master/assets/images/logo-optimiza.png"></a>
    </div>
